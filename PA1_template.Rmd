...
### *Mean total number of steps is `r m` and median value is `r md`.*
...
### *The interval  `r Int_max` contains the max number of steps on average across all days.*
...
### *Mean total number of steps is `r m` and median value is `r md`. No major effect on mean and median by imputing missing values*
